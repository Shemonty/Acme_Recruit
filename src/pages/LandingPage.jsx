...
const SAMPLE_JOBS = [
  {
    ...
    level: 'Intermediate',
    description: 'React, TypeScript, REST APIs. 2+ years experience required.',
    applicants: 87,
  ...
  },
  {
    ...
    department: 'Engineering',
    level: 'Senior',
    description: 'Node.js, PostgreSQL, system design. 5+ years required.',
    applicants: 52,
  ...
  },
  {
    ...
    level: 'Beginner',
    description: 'Excel, SQL, Power BI. Fresh graduates welcome.',
    applicants: 114,
    closes_at: '2026-05-18',
    num_questions: 8,
    status: 'published',
  },
  {
    ...
    department: 'Design',
    level: 'Intermediate',
    description: 'Figma, user research, design systems. Portfolio required.',
    applicants: 39,
  ...
  },
  {
    ...
    department: 'AI/ML',
    level: 'Senior',
    description: 'PyTorch, model fine-tuning, LLMOps. Computer vision experience preferred.',
    applicants: 61,
  ...
  },
  {
    ...
    department: 'Engineering',
    level: 'Intermediate',
    description: 'CI/CD, Docker, Kubernetes, AWS. 3+ years experience.',
    applicants: 44,
...
async function fetchJobs() {
  ...
  try {
    ...
    else setJobs([])  // ← don't show mock on landing either
  } finally {
    setLoading(false)
  }
}
    ...
    <div className="min-h-screen bg-[#1d222f] text-white font-sans">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[#0f1117]/90 backdrop-blur border-b border-white/10">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8 text-sm text-gray-200">
            ...
            <a href="https://www.acmeai.tech" target="_blank" className="hover:text-white transition-colors text-white">Website</a>
          </div>
          <div className="flex items-center gap-2">
            <a
              href="/candidate/login"
              className="px-4 py-2 text-sm font-medium border border-purple-300 text-purple-300 rounded-lg hover:bg-purple-500 hover:text-white transition-all duration-200"
            >
              Login as Candidate
            </a>
            <a
              href="/hr/login"
              className="px-4 py-2 text-sm font-medium border border-blue-300 text-blue-300 rounded-lg hover:bg-blue-500 hover:text-white transition-all duration-200"
            >
              Login as HR
            </a>
          </div>
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 py-24">
          <div className="flex flex-col lg:flex-row items-start gap-16">
            ...
            <div className="flex-1">
              ...
              <h1 className="text-5xl font-bold lea ding-tight tracking-tight mb-6">
                Hypercharge your<br />
                <span className="text-blue-400">career with AI.</span>
              </h1>
              <p className="text-gray-200 text-lg leading-relaxed mb-8 max-w-xl">
                Acme AI Ltd. is a full-service AI enterprise, supporting global AI giants with data annotation,
                model fine-tuning, and capacity strengthening. We specialise in computer vision, speech recognition,
                and GenAI solutions. The largest AI and data enterprise in Bangladesh.
              </p>
              <p className="text-gray-300 text-sm leading-relaxed mb-10 max-w-xl">
                Join our team and work at the frontier of artificial intelligence. Our AI-powered interview
                process is fast, fair, and designed to find the best, hear back within 3–5 business days.
              </p>
              <div className="flex items-center gap-4">
                <a
                  href="#jobs"
                  className="px-6 py-3 bg-blue-700 hover:bg-blue-500 text-white font-medium rounded-lg transition-all duration-200 text-sm"
                >
                  View Open Positions
                </a>
                <a
                  ...
                  target="_blank"
                  className="px-6 py-3 text-gray-300 hover:text-white font-medium text-sm transition-colors"
                >
                  Learn more →
                </a>
              </div>
      ...
      <section id="jobs" className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          {/* Count */}
          <div className="text-xs font-semibold text-gray-100 uppercase tracking-widest mb-5">
...
function JobCard({ job, formatDate }) {
  return (
    <div className="group bg-white/[0.03] border border-white/10 rounded-xl p-5 hover:border-blue-500/40 hover:bg-white/[0.05] transition-all duration-200">
      <div className="flex items-start justify-between mb-3">
        <div>
          ...
          <p className="text-xs text-gray-300 mt-0.5">
            {job.department} · {job.work_type || 'Remote'}
          </p>
        </div>
        <span className={`text-xs px-2.5 py-1 rounded-full border ${LEVEL_COLORS[job.level] || 'text-gray-300 border-gray-600'}`}>
          {job.level}
        </span>
      </div>
      ...
      <a
        href={`/apply/${job.id}`}
        className="inline-block px-4 py-2 bg-white/10 hover:bg-blue-700 text-white text-sm font-medium rounded-lg transition-all duration-200"
      >
        Apply now
      </a>
    </div>
...
function AcmeChatbot() {
  ...
  const [messages, setMessages] = useState([
    {
      role: 'assistant',
      text: "Hi! I'm Acme AI's assistant. Ask me anything about the company, our services, or open positions! 👋",
    },
  ])
  ...
  const SYSTEM_PROMPT = `You are a friendly, concise assistant for Acme AI Ltd., a leading AI enterprise headquartered in Dhaka, Bangladesh.

COMPANY FACTS:
- Full name: Acme AI Ltd.
- Founded: Bangladesh-based, operating globally
- Website: https://www.acmeai.tech
- Specialties: Data Annotation & Labelling, Computer Vision, GenAI Solutions, Speech Recognition, LLMOps, Remote Team Placements, B2B AI Consultation
- Team: 400+ in-house AI professionals
- Scale: 31,000+ annotation hours/month, 98.34% average accuracy rate
- Partners: 50+ global partners including major AI companies
- Reputation: Largest AI and data enterprise in Bangladesh
- Hiring: Uses an AI-powered interview platform — candidates apply, take an AI interview, and hear back within 3–5 business days
- Interview process: Candidates register, take AI-generated interview questions, get auto-scored, shortlisted if ≥80%, then HR reviews

TONE RULES:
- Be concise — 2 to 4 sentences max per reply
- Be friendly and professional
- If asked about jobs/careers, direct them to scroll to "Open Positions" or click "Apply now" on a job card
- If asked something you don't know, say you're not sure and suggest visiting acmeai.tech or contacting HR
- Never make up facts not listed above`
  ...
  return (
    <>
      ...
      {!open && (
        <div
          className="fixed bottom-[62px] right-[62px] z-50 w-3 h-3 rounded-full border-2 border-[#1d222f]"
      ...
      {open && (
        ...
        >
          ...
          <div
            ...
            style={{
              background: 'linear-gradient(135deg, rgba(30,58,138,0.8), rgba(37,99,235,0.4))',
